...
db_foreach grade_type { *SQL* } {
    set grade_label_${grade_id} "$grade_name ($weight %) <a href=[export_vars -base "grades-type-reports" { grade_id }]><img src=\"/resources/acs-subsite/Zoom16.gif\" width=\"16\" height=\"16\" border=\"0\"></a>"
